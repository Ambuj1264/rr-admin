...
const ServicesDescription = () => {
  ...
  const addServices = async () => {
    try {
      ...
      if (result.data) {
          refetch();
        successToast("Your home page brief has been added successfully");
  ...
  function renderActions() {
    return (
      ...
      <div className={classes.actionsContainer}>
        ...
        {data?.serviceDesciptionModule ?"" :<Button type="submit" color="success" variant="contained"> Submit</Button>}
  ...
  return (
    <><Helmet>
    <title>Add Home Page Brief</title>
  </Helmet>
  <PageTitleWrapper>
    <PageTitle heading="Add Home Page Brief" />
  </PageTitleWrapper>
