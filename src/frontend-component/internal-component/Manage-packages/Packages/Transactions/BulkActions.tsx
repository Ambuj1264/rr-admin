...
import { bulkDeletePackagesMuation } from "src/hook/mutations/prakages";
...
function BulkActions({ selectedValue }) {
  ...
  const [bulkItemsDelete, { loading }] = useMutation(bulkDeletePackagesMuation,{
    context:{
      headers: {
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const result = await bulkItemsDelete({
            variables: {
              ids: selectedValue,
            },
          });
