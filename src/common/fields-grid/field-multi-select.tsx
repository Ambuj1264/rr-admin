...
import { IFieldProps, renderPlainTextField, selectOption, renderProposed, listOption} from "./field-utils";
import AutoCompleteSelectValidator from "../input-validators/autocomplete-select-validator";
import { DateRange } from "react-date-range";

export const FieldMultipleSelect: FunctionComponent<IFieldProps> = (
  props: IFieldProps,
) => {
  const {
    id,
